...
{
    auto code = HilbertToLinear<32, std::uint32_t, std::uint64_t>;
    BOOST_CHECK_EQUAL(code(0x00000000, 0x00000000), 0x0000000000000000);
    BOOST_CHECK_EQUAL(code(0xffffffff, 0x00000000), 0xffffffffffffffff);
    BOOST_CHECK_EQUAL(code(0x00000000, 0x80000000), 0x4000000000000000);
    BOOST_CHECK_EQUAL(code(0x80000000, 0x80000000), 0x8000000000000000);
    BOOST_CHECK_EQUAL(code(0xffffffff, 0x80000000), 0xbfffffffffffffff);
}
